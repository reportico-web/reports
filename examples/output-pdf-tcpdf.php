<?php
      ...
      \Reportico\Engine\Builder::build()
          ...
          ->page()
            ...
            ->header("{REPORT_TITLE}", "border-width: 0px 0px 1px 0px; margin: 25px 0px 0px 0px; border-color: #000000; font-size: 18; border-style: solid;padding:0px 0px 0px 0px; background-color: #000; color: #fff; margin-left: 0%;margin-bottom: 70px;text-align:center")
